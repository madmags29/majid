...
export const EXLPORE_DESTINATIONS: DestinationOption[] = [
    ...
    // Asia Expansion
    { id: 'seoul', name: 'Seoul', country: 'South Korea', image: 'https://placehold.co/800x600?text=Seoul', imageAlt: 'Night view of the N Seoul Tower and futuristic skyline of Seoul city', lat: 37.5665, lng: 126.9780, tags: ['City', 'Technology', 'Food'] },
    ...
    // Europe Expansion
    { id: 'prague', name: 'Prague', country: 'Czech Republic', image: 'https://placehold.co/800x600?text=Prague', imageAlt: 'Gothic spires of Prague Castle and the Vltava River bridge in the Czech Republic', lat: 50.0755, lng: 14.4378, tags: ['Architecture', 'History', 'City'] },
    { id: 'lisbon', name: 'Lisbon', country: 'Portugal', image: 'https://placehold.co/800x600?text=Lisbon', imageAlt: 'Yellow tram climbing the steep cobblestone streets of Alfama in Lisbon, Portugal', lat: 38.7223, lng: -9.1393, tags: ['Coastal', 'Tram', 'City'] },
    ...
    { id: 'cairo', name: 'Cairo', country: 'Egypt', image: 'https://placehold.co/800x600?text=Cairo', imageAlt: 'Great Pyramids of Giza silhouetted against a golden desert sunset in Cairo, Egypt', lat: 30.0444, lng: 31.2357, tags: ['Pyramids', 'Ancient', 'History'] },
    ...
    { id: 'capetown', name: 'Cape Town', country: 'South Africa', image: 'https://placehold.co/800x600?text=Cape+Town', imageAlt: 'Table Mountain looming over the vibrant V&A Waterfront in Cape Town', lat: -33.9249, lng: 18.4241, tags: ['Mountains', 'Nature', 'City'] },
