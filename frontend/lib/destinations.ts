...
export const EXLPORE_DESTINATIONS: DestinationOption[] = [
    ...
    { id: 'mumbai', name: 'Mumbai', country: 'India', image: 'https://images.pexels.com/photos/8218461/pexels-photo-8218461.jpeg?auto=compress&cs=tinysrgb&w=800', lat: 19.0760, lng: 72.8777, tags: ['City', 'Culture', 'Food'] },
    ...
    { id: 'munnar', name: 'Munnar', country: 'India', image: 'https://images.pexels.com/photos/13691355/pexels-photo-13691355.jpeg?auto=compress&cs=tinysrgb&w=800', lat: 10.0889, lng: 77.0595, tags: ['Nature', 'Tea Gardens', 'Hills'] },
    ...
    { id: 'rishikesh', name: 'Rishikesh', country: 'India', image: 'https://images.pexels.com/photos/28570070/pexels-photo-28570070.jpeg?auto=compress&cs=tinysrgb&w=800', lat: 30.0869, lng: 78.2676, tags: ['Spiritual', 'Yoga', 'Rafting'] },
    ...
    { id: 'abudhabi', name: 'Abu Dhabi', country: 'UAE', image: 'https://images.pexels.com/photos/5713365/pexels-photo-5713365.jpeg?auto=compress&cs=tinysrgb&w=800', lat: 24.4539, lng: 54.3773, tags: ['City', 'Culture', 'Luxury'] },
    ...
    { id: 'vancouver', name: 'Vancouver', country: 'Canada', image: 'https://images.pexels.com/photos/29072584/pexels-photo-29072584.jpeg?auto=compress&cs=tinysrgb&w=800', lat: 49.2827, lng: -123.1207, tags: ['City', 'Mountains', 'Nature'] },
];
